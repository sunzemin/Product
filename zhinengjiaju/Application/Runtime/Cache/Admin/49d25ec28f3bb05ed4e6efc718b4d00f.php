...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/AboutUs/all_classify_add/p/<?php echo ($p); ?>">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($all_classify_res)): $k = 0; $__LIST__ = $all_classify_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td>
                             <a href="/index.php/Admin/AboutUs/little_classify/ac_id/<?php echo ($vo["ac_id"]); ?>/p/1">二级分管理</a> 
                            <a href="/index.php/Admin/AboutUs/all_classify_update/ac_id/<?php echo ($vo["ac_id"]); ?>/p/<?php echo ($p); ?>">修改</a>
                            <a href="/index.php/Admin/AboutUs/all_classify_del/ac_id/<?php echo ($vo["ac
