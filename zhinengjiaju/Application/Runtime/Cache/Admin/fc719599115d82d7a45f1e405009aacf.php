...
<script type="text/javascript">
    ...
    KindEditor.ready(function(k){
        editor=k.create('textarea[name="lu_map"],textarea[name="lu_transport"]',{
            filterMode:false
        })
        var editor = k.editor({
...
<ul class="forminfo">
    ...
    <li><label><b>*</b>地图定位</label><textarea name="lu_map" type="text" class="dfinput" style="width: 500px;height: 400px;"><?php echo ($link_us_res["lu_map"]); ?></textarea></li>
    <li><label><b>*</b>QQ</label><input name="lu_qq" type="text" class="dfinput" value="<?php echo ($link_us_res["lu_qq"]); ?>" /></li>
    <li><label><b>*</b>二维码图片</label>
            <input name="lu_erweima" type="text" id="url1" value="<?php echo ($link_us_res["lu_erweima"]); ?>" class="dfinput"/>
            <input name="" type="button" id="image1"  class="scbtn1" value="选择图片" />
        </li>
    <li><label><b>*</b>热线电话</label><input name="lu_telephone" type="text" class="dfinput" value="<?php echo ($link_us_res["lu_telephone"]); ?>" /></li>
