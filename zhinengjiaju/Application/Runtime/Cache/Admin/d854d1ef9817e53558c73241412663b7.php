...
<ul class="forminfo">
    ...
    <li><label><b>*</b>行业名称</label><input name="pb_name" type="text" class="dfinput" value=""></li>
    <li><label><b>*</b>照片</label><input name="pb_image" type="text" class="dfinput" value="" id="url1"/><input type="button" id="image1" class="scbtn1" value="选择图片"></li>
    <li><label><b>*</b>排序</label><input name="pb_sort" type="text" class="dfinput" value="" /></li>
