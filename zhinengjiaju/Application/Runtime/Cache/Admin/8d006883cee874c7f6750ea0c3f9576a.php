...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/AboutUs/classify_article_add/p/<?php echo ($p); ?>/lc_id/<?php echo ($lc_id); ?>">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($classify_article_res)): $k = 0; $__LIST__ = $classify_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td>
                            <a href="/index.php/Admin/AboutUs/classify_article_update/ca_id/<?php echo ($vo["ca_id"]); ?>/lc_id/<?php echo ($lc_id); ?>/p/<?php echo ($p); ?>">修改</a>
                            <a href="/index.php/Admin/AboutUs/classify_article_del/ca_id/<?php echo ($vo["ca_id"]); ?>/lc_id/<?php echo ($lc_id); ?>/p/<?php echo ($p); ?>" onclick="return del()">删除</a>
                        </td>
