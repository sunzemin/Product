...
<ul class="forminfo">
    <input name="auc_id" type="text" class="dfinput" value="<?php echo ($about_us_classify["auc_id"]); ?>" />
    ...
    <li><label><b>*</b>分类名称</label><input name="auc_name" type="text" class="dfinput" value="<?php echo ($about_us_classify["auc_name"]); ?>" /></li>
    
    <li><label><b>*</b>排序</label><input name="auc_sort" type="text" class="dfinput" value="<?php echo ($about_us_classify["auc_sort"]); ?>" /></li>
