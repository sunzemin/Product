...
<ul class="placeul">
<li><a href="#">主营业务</a></li>
<li><a href="#">业务文章管理</a></li>
<li><a href="#">修改业务文章</a></li>
</ul>
</div>
<form method="post" name="form" action="">
<ul class="forminfo">
    <input name="pw_id" type="hidden" class="dfinput" value="<?php echo ($primary_work["pw_id"]); ?>" />
    <li><label><b>*</b>分类名称</label>
        <select name="pwc_id" class="dfinput">
            <option value="<?php echo ($primary_work_classify["pwc_id"]); ?>"><?php echo ($primary_work_classify["pwc_name"]); ?></option>
    ...
    <li><label><b>*</b>业务名称</label><input name="pw_name" type="text" class="dfinput" value="<?php echo ($primary_work["pw_name"]); ?>" /></li>
    <li><label><b>*</b>图标</label><input name="pw_image" type="text" class="dfinput" value="<?php echo ($primary_work["pw_image"]); ?>" id="url2"/><input type="button" id="image2" class="scbtn1" value="选择图片"></li>
    <li><label><b>*</b>是否推荐</label>
        <select name="pw_flag" class="dfinput">
            <?php if($primary_work["pw_flag"] == 0): ?><option value="0">不推荐到首页</option>
    ...
    <li><label><b>*</b>排序</label><input name="pw_sort" type="text" class="dfinput" value="<?php echo ($primary_work["pw_sort"]); ?>" /></li>
