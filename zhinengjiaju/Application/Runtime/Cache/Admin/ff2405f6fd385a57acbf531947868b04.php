...
<form method="post" name="form" action="">
	<ul class="forminfo">
        ...
        <li><label><b>*</b>英文标题1</label><input name="ah_title4" type="text" class="dfinput" value="<?php echo ($all_head["ah_title4"]); ?>" /></li>
        ...
        <li><label><b>*</b>标题3</label>
            <textarea name="ah_title3"  class="dfinput" style="width: 400px;height: 300px;"><?php echo ($all_head["ah_title3"]); ?></textarea>
        </li>
