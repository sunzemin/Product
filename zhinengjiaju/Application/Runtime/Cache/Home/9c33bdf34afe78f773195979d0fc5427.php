			...
			<div class="Situation-right">
				...
				<div class="questions-tab">
					<?php if($news_articles1 == null): ?><a>上一篇: 没有了 </a>
						<?php else: ?>
						<a href="/index.php/Home/Index/industry/nav_id/<?php echo ($navfirst["nav_id"]); ?>/na_id/<?php echo ($news_articles1["na_id"]); ?>/nc_id/<?php echo ($news_classify_res["nc_id"]); ?>">上一篇: <?php echo ($news_articles1["na_title"]); ?> </a><?php endif; ?>
					<?php if($news_articles2 == null): ?><a>下一篇: 没有了 </a>
						<?php else: ?>
						<a href="/index.php/Home/Index/industry/nav_id/<?php echo ($navfirst["nav_id"]); ?>/na_id/<?php echo ($news_articles2["na_id"]); ?>/nc_id/<?php echo ($news_classify_res["nc_id"]); ?>">下一篇: <?php echo ($news_articles2["na_title"]); ?> </a><?php endif; ?>
