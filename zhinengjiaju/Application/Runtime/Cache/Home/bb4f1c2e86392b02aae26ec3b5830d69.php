...
//												console.log('ggggg',data.classify_article_res[i].ca_id);
												var con = '<a href="/index.php/Home/Index/xinwenxiangqing/ca_id/'+data.classify_article_res[i].ca_id+'/nav_id/<?php echo ($nav_id); ?>/lc_id/"'+lc_id+' class=" animated fadeInUp"><div class="trend_left"><img src="' +
									...
									jump: function(obj, first) {
										...
										$.ajax({
											...
											success: function(data) {
												$(".dynamicCon").children().remove();
												for(var i = 0; i < data.classify_article_res.length; i++) {
													var con = '<a href="/index.php/Home/Index/xinwenxiangqing/ca_id/'+data.classify_article_res[i].ca_id+'/nav_id/<?php echo ($nav_id); ?>" class=" animated fadeInUp"><div class="trend_left"><img src="' +
														data.classify_article_res[i].ca_image +
														'" alt="..." /></div><div class="trend-right"><div>' +
														data.classify_article_res[i].ca_title +
														'</div><div>' +
