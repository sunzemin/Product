								...
								jump: function(obj, first) {
									...
									$.ajax({
										...
										success: function(data) {
											...
											console.log('jjjjj', data.little_classify_res);
											var ind=$('.style>div').index();
											console.log('下标',ind);
											if(ind==1){
												for(var j=0;j<data.classify_article_res.length;j++){
												var even='<div class="EuropeanStyle"><div class = "EuropeanStyle-right show"><a href = "javascript:;" class = "animated bounceInDown"><div><img src = "'+
													data.classify_article_res[i].ca_image+
													'" alt = "..." /></div><div class = "hide1">'+
													data.classify_article_res[i].ca_title+
													'</div></a><a href = "javascript:;" class ="animated bounceInUp"><div><img src = "'+
													data.classify_article_res[i].ca_image+
													'"alt = "..." /></div><div class = "hide1">'+
													data.classify_article_res[i].ca_title+
													'</div></a></div><div class = "EuropeanStyle-left show animated bounceInLeft"><a href = "javascript:;"><div><img src = "'+
													data.classify_article_res[i].ca_image+
													'" alt = "..." /></div><div class = "hide1">'+
													data.classify_article_res[i].ca_title+
													'</div></a></div></div>';
											...
											for(var i = 0; i < data.classify_article_res.length; i++) {
												var con = '<div class="EuropeanStyle"><div class = "EuropeanStyle-left show animated bounceInLeft"><a href = "javascript:;"><div><img src = "'+
													data.classify_article_res[i].ca_image+
													'" alt = "..." /></div><div class = "hide1">'+
													data.classify_article_res[i].ca_title+
													'</div></a></div><div class = "EuropeanStyle-right show"><a href = "javascript:;" class = "animated bounceInDown"><div><img src = "'+
													data.classify_article_res[i].ca_image+
													'" alt = "..." / ></div><div class = "hide1">'+
													data.classify_article_res[i].ca_title+
													'</div></a><a href = "javascript:;" class ="animated bounceInUp"><div><img src = "'+
