...
<form method="post" name="form" action="">
	<ul class="forminfo">
	    ...
	    <li><label><b>*</b>作者</label><input name="author" type="text" class="dfinput" value="<?php echo ($case["author"]); ?>" /></li>
        
        <li><label><b>*</b>图片小标题</label><input name="imagetitle" type="text" class="dfinput" value="<?php echo ($case["imagetitle"]); ?>" /></li>
        <li><label><b>*</b>详细介绍</label><textarea name="c_content" type="text" class="dfinput" value="" style="width:500px;height: 400px;"><?php echo ($case["c_content"]); ?></textarea></li>
