...
<ul class="forminfo">
	...
	<li><label><b>*</b>父级导航</label>
		<select name="fid" class="dfinput state">
            <?php if(parentnav == 0): ?><option value="0">一级导航</option>
                <?php else: ?>
    ...
    <li><label><b>*</b>导航英文名称</label><input name="nav_english_name" type="text" class="dfinput" value="<?php echo ($navdata["nav_english_name"]); ?>" /></li>
    ...
    <!-- <li><label><b>*</b>是否推荐</label>
        <select name="nav_state" class="dfinput state">
            <?php if($navdata["nav_state"] == 0): ?><option value="0">不推荐到首页</option>
