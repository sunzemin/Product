...
<script type="text/javascript">
    ...
    KindEditor.ready(function(k){
        editor=k.create('textarea[name="cc_content"]',{
            filterMode:false
        })
        var editor = k.editor({
...
<ul class="forminfo">
    ...
    <li><label><b>*</b>企业文化</label><textarea name="cc_content" type="text" class="dfinput" value="" style="width:500px;height: 400px;"><?php echo ($company_culture["cc_content"]); ?></textarea></li>
    
    <li><label><b>*</b>排序</label><input name="cc_sort" type="text" class="dfinput" value="<?php echo ($company_culture["cc_sort"]); ?>" /></li>
