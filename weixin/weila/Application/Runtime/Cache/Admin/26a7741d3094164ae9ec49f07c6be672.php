...
<ul class="forminfo">
    ...
    <li><label><b>*</b>证书名称</label><input name="title" type="text" class="dfinput" value=""></li>
    <li><label><b>*</b>证书照片</label><input name="image" type="text" class="dfinput" value="" id="url1"/><input type="button" id="image1" class="scbtn1" value="选择图片"></li>
