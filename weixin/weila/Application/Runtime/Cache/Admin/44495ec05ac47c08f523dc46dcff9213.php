...
<ul class="forminfo">
    ...
    <li><label><b>*</b>分类名称</label><input name="pwc_name" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>排序</label><input name="pwc_sort" type="text" class="dfinput" value="" /></li>
