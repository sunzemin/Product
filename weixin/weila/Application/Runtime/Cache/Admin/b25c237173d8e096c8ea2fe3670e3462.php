...
<script type="text/javascript">
    ...
    KindEditor.ready(function(k){
        editor=k.create('textarea[name="ci_content"]',{
            filterMode:false
        })
        var editor = k.editor({
...
<ul class="placeul">
<li><a href="#">关于我们</a></li>
<li><a href="#">适用行业管理</a></li>
<li><a href="#">添加行业信息</a></li>
</ul>
</div>
<form method="post" name="form" action="">
<ul class="forminfo">
    <input name="pb_id" type="hidden" class="dfinput" value="<?php echo ($proper_bussiness["pb_id"]); ?>" />
    ...
    <li><label><b>*</b>行业名称</label><input name="pb_name" type="text" class="dfinput" value="<?php echo ($proper_bussiness["pb_name"]); ?>"></li>
    <li><label><b>*</b>照片</label><input name="pb_image" type="text" class="dfinput" value="<?php echo ($proper_bussiness["pb_image"]); ?>" id="url1"/><input type="button" id="image1" class="scbtn1" value="选择图片"></li>
    <li><label><b>*</b>排序</label><input name="pb_sort" type="text" class="dfinput" value="<?php echo ($proper_bussiness["pb_sort"]); ?>" /></li>
