...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/Talent/jobadd/p/<?php echo ($p); ?>">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($job_res)): $k = 0; $__LIST__ = $job_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($k); ?></td>
                        <td><?php echo ($vo["jname"]); ?></td>
                        <td><?php echo ($vo["jjob"]); ?></td>
                        <td><?php echo ($vo["jnum"]); ?></td>
                        
                        
                        <td><?php echo ($vo["jsort"]); ?></td>
                        <td>
                            
                            <a href="/index.php/Admin/Talent/jobupdate/jid/<?php echo ($vo["jid"]); ?>/p/<?php echo ($p); ?>">修改</a>
                            <a href="/index.php/Admin/Talent/jobdel/jid/<?php echo ($vo["jid"]); ?>/p/<?php echo ($p); ?>" onclick="return del()">删除</a>
                        </td>
