		...
		<section>
			...
			<div class="StyleSample paddingBottom">
				<div class="StyleSample-top">
					<?php if(is_array($caseData)): $i = 0; $__LIST__ = $caseData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$case): $mod = ($i % 2 );++$i;?><a href="/index.php/Home/Index/Information/id/<?php echo ($case["id"]); ?>/nav_id/<?php echo ($nav_id); ?>" target="_blank" class="StyleSampleImages">
