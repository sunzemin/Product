			...
			<div id="video">
			    ...
			    <div class="videoCent">
					<div class="videoCent-top">
						我们拍的不只是婚纱照,还有微电影,为您拍一段故事,记录穿着婚纱的旅行
					</div>
					<div class="videoCent-bot">
						We are not only taking wedding photos, but also micro-movies, taking a story for you and recording the trip in a wedding dress.
					</div>  	
			    </div>
			    <a href="javasacript:;" target="_blank" class="videoCentImages">
				    <img src="/Public/Home/img/img35.png" alt="img"/>
			    </a>
			    <a href="javascript:;" target="_blank" class="videoCentCheack">点击查看更多精彩花絮</a>
			</div>
			<!--客户真实评价-->
								...
								<div class="evaluateCentData-top">
									...
									<div class="evaluateCentData-right">
										...
										<div class="evaluateCentData-Images">
											<?php $__FOR_START_30791__=1;$__FOR_END_30791__=$custom_word["cw_word_rank"];for($i=$__FOR_START_30791__;$i < $__FOR_END_30791__;$i+=1){ ?><img src="/Public/Home/img/img40.png" alt="img"/><?php } ?>
										</div>
