...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/Public/Mobile/layui/css/layui.css" />
...
<?php if($navben == null): ?><input type="hidden" class="navcss" value="首页">
	...
	<div class="AdressData">
		...
		<input type="hidden" id="rscId" value="<?php echo ($room_scenery_classify11["rsc_id"]); ?>" />
		<!--公共底部-->
		<footer>
	...
	<div class="footer-six">
		...
		<script src="/Public/Mobile/layui/layui.js" type="text/javascript" charset="utf-8"></script>
