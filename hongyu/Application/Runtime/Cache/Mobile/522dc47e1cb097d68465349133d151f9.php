...
<div class="nav">
 ...
 <input type="hidden" class="navcss" value="<?php echo ($navben["nav_name"]); ?>"> 
		...
		<!--人才招聘-->
		<div class="personnel">
			<div class="personnel-top">人才招聘中心</div>
			<div class="personnel-bot">
				<?php if(is_array($job11_res)): $i = 0; $__LIST__ = $job11_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$job): $mod = ($i % 2 );++$i;?><div class="personnel_table">
					<div>招聘岗位：<span><?php echo ($job["jjob"]); ?></span></div>
					<div>招聘人数：<span><?php echo ($job["jnum"]); ?></span></div>
					<div>任职要求：<?php echo ($job["jrequire"]); ?>
					</div>
					<div>
						<a href="/index.php/Mobile/Index/personnel1/jid/<?php echo ($job["jid"]); ?>/nav_id/<?php echo ($nav_id); ?>">查看详情</a>
					</div>
