...
<ul class="forminfo">
    ...
    <input name="id" type="hidden" class="dfinput" value="<?php echo ($certificate["id"]); ?>" />
    <li><label><b>*</b>证书名称</label><input name="title" type="text" class="dfinput" value="<?php echo ($certificate["title"]); ?>"></li>
    <li><label><b>*</b>证书照片</label><input name="image" type="text" class="dfinput" value="<?php echo ($certificate["image"]); ?>" id="url1"/><input type="button" id="image1" class="scbtn1" value="选择图片"></li>
    
    <li><label><b>*</b>排序</label><input name="sort" type="text" class="dfinput" value="<?php echo ($certificate["sort"]); ?>" /></li>
