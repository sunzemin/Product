...
<form method="post" name="form" action="">
	<ul class="forminfo">
		<input name="lb_id" type="hidden" class="dfinput" value="<?php echo ($lunbodata["lb_id"]); ?>" />
		<li><label><b>*</b>标题</label><input name="lb_title" type="text" class="dfinput" value="<?php echo ($lunbodata["lb_title"]); ?>" /></li>
		<li><label><b>*</b>英文标题</label><input name="lb_title_english" type="text" class="dfinput" value="<?php echo ($lunbodata["lb_title_english"]); ?>" /></li>
