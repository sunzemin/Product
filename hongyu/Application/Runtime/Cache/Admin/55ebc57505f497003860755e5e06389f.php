...
<ul class="forminfo">
    <li><label><b>*</b>分类名称</label><input name="hc_name" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>分类图标</label>
            <input name="hc_titleimage" type="text" id="url1" value="" class="dfinput"/>
            <input name="" type="button" id="image1"  class="scbtn1" value="选择图片" />
        </li>
    <li><label><b>*</b>排序</label><input name="hc_sort" type="text" class="dfinput" value="" /></li>
