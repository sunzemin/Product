...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/HomeManage/home_little_classify_add/p/<?php echo ($p); ?>/ac_id/<?php echo ($ac_id); ?>">
            ...
            <tbody>
                <?php if(is_array($home_little_classify_res)): $k = 0; $__LIST__ = $home_little_classify_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td>
                            ...
                            <a href="/index.php/Admin/HomeManage/home_little_classify_update/hlc_id/<?php echo ($vo["hlc_id"]); ?>/p/<?php echo ($p); ?>/ac_id/<?php echo ($ac_id); ?>">修改</a>
                            <a href="/index.php/Admin/HomeManage/home_little_classify_del/hlc_id/<?php echo ($vo["hlc_id"]); ?>/p/<?php echo ($p); ?>/ac_id/<?php echo ($ac_id); ?>" onclick="return del()">删除</a>
                        </td>
