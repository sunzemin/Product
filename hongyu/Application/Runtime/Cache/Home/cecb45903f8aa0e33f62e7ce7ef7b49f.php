	...
	<input type="hidden" class="navcss" value="<?php echo ($navfirst["nav_name"]); ?>">
		...
		<div class="Situation">
			<div class="leftbox">
				...
				<input type="hidden" class="navcss11" value="<?php echo ($navben["nav_name"]); ?>">
			...
			<div class="Situation-right">
				...
				<div>
						<div class="SituationRight-top">
							<span>您当前位置：<a href="/index.php/Home/Index/index">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($news_classify11["nc_name"]); ?></span>
							<h1><?php echo ($news_classify11["nc_name"]); ?></h1>
						</div>
						<div class="SituationRight-bot">
							<?php if(is_array($news_article_res)): $m = 0; $__LIST__ = $news_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news_article): $mod = ($m % 2 );++$m; if($m < 10): ?><div class="news">
									...
									<div class="news-right">
										<div><a href="/index.php/Home/Index/industry/na_id/<?php echo ($news_article["na_id"]); ?>/nav_id/<?php echo ($news_classify11["nav_id"]); ?>"><?php echo ($news_article["na_title"]); ?></a></div>
						...
						<div class="SituationRight-top">
							<span>您当前位置：<a href="/index.php/Home/Index/index">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($news_classify["nc_name"]); ?></span>
							<h1><?php echo ($news_classify["nc_name"]); ?></h1>
						</div>
						<div class="SituationRight-bot">
							<?php if(is_array($news_article_res)): $m = 0; $__LIST__ = $news_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news_article): $mod = ($m % 2 );++$m; if($m < 10): ?><div class="news">
									<div class="news-left">
									...
									<div class="news-right">
										<div><a href="/index.php/Home/Index/industry/na_id/<?php echo ($news_article["na_id"]); ?>/nav_id/<?php echo ($news_classify["nav_id"]); ?>"><?php echo ($news_article["na_title"]); ?></a></div>
										<div><?php echo ($news_article["na_content"]); ?></div>
									</div>
									<?php else: ?>
									<div class="news">
