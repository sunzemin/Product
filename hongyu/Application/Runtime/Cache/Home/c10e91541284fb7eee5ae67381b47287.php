			...
			<div class="Situation-right">
				<?php if(is_array($primary_work_res)): $k = 0; $__LIST__ = $primary_work_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$primary_work): $mod = ($k % 2 );++$k; if($k == 1): ?><div>
						...
						<div style="display: none">
							...
							<div class="SituationRight-bot">
								<?php if(is_array($primary_article_res[$k-1])): $i = 0; $__LIST__ = $primary_article_res[$k-1];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$primary_article): $mod = ($i % 2 );++$i; echo ($primary_article["pa_content"]); endforeach; endif; else: echo "" ;endif; ?>
