...
<body style="background:#f0f9fd;">
    ...
    <dl class="leftmenu" style="background:url(/Public/admin/images/pic/leftline.gif) repeat-y right;">
        ...
        <dd>
            <ul class="menuson">
                <li><cite></cite><a href="/index.php/Admin/HomeManage/service_advantage/p/1" target="rightFrame">服务优势管理</a><i></i></li>
                <li><cite></cite><a href="/index.php/Admin/HomeManage/cooperate_company/p/1" target="rightFrame">合作企业管理</a><i></i></li>
