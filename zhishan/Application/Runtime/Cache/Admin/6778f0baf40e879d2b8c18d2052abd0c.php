    ...
    <dl class="leftmenu" style="background:url(/Public/admin/images/pic/leftline.gif) repeat-y right;">
        ...
        <dd>
            <ul class="menuson">
                ...
                <li><cite></cite><a href="/index.php/Admin/index/user/p/1" target="rightFrame">用户管理</a><i></i></li>
                <li><cite></cite><a href="/index.php/Admin/index/lunbo/p/1" target="rightFrame">轮播管理</a><i></i></li>
                <li><cite></cite><a href="/index.php/Admin/index/friend_url/p/1" target="rightFrame">友情链接</a><i></i></li>
