...
<ul class="forminfo">
    <input name="nc_id" type="hidden" class="dfinput" value="<?php echo ($news_classify_res["nc_id"]); ?>" />
    ...
    <li><label><b>*</b>名称</label><input name="nc_name" type="text" class="dfinput" value="<?php echo ($news_classify_res["nc_name"]); ?>" /></li>
    <li><label><b>*</b>排序</label><input name="nc_sort" type="text" class="dfinput" value="<?php echo ($news_classify_res["nc_sort"]); ?>" /></li>
