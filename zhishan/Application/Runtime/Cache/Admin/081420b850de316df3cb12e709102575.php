...
<ul class="forminfo">
    ...
    <li><label><b>*</b>简介</label><textarea name="ci_content" type="text" class="dfinput" value="" style="width:500px;height: 400px;"></textarea></li>
    ...
    <li><label><b>*</b>热线电话</label><input name="ci_telephone" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>排序</label><input name="ci_sort" type="text" class="dfinput" value="" /></li>
