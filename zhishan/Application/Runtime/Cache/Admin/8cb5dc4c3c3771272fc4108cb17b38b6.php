...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/index/friend_url_add/p/1">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($friend_urlData)): $k = 0; $__LIST__ = $friend_urlData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($k); ?></td>
                        <td><img src="<?php echo ($vo["fu_image"]); ?>" height="40px;"></td>
                        <td><?php echo ($vo["fu_url"]); ?></td>
                        <td><?php echo ($vo["fu_sort"]); ?></td>
                        
                        
                        <td>
	                        <a href="/index.php/Admin/index/friend_url_update/fu_id/<?php echo ($vo["fu_id"]); ?>/p/1">修改</a>
	                        <a href="/index.php/Admin/index/friend_url_del/fu_id/<?php echo ($vo["fu_id"]); ?>/p/1" onclick="return del()">删除</a>
                        </td>
