...
<ul class="forminfo">
    ...
    <li><label><b>*</b>热线电话</label><input name="ci_telephone" type="text" class="dfinput" value="<?php echo ($company_introduce["ci_telephone"]); ?>" /></li>
    <li><label><b>*</b>排序</label><input name="ci_sort" type="text" class="dfinput" value="<?php echo ($company_introduce["ci_sort"]); ?>" /></li>
