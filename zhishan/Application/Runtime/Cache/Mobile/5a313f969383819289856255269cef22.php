		...
		<div class="Situation">
			...
			<div class="Situation-bot">
				<div class="SituationRight-top">
					...
					<?php if(is_array($policy_article_res)): $i = 0; $__LIST__ = $policy_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$policy_article): $mod = ($i % 2 );++$i;?><p><?php echo ($policy_article["pa_content"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
				    </div>
