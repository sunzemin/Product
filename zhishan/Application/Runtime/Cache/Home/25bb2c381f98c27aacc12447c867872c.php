				...
				<div class="sub-nav">
					...
					<ul>
						<?php if(is_array($navsecond)): $k = 0; $__LIST__ = $navsecond;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$second): $mod = ($k % 2 );++$k; if($k == 1): ?><li class="on">
									<a href="<?php echo ($second["nav_url"]); ?>/nav_id/<?php echo ($second["nav_id"]); ?>"><?php echo ($second["nav_name"]); ?></a><b>&gt;</b>
								</li>
								<?php else: ?>
								<li>
									<a href="<?php echo ($second["nav_url"]); ?>/nav_id/<?php echo ($second["nav_id"]); ?>"><?php echo ($second["nav_name"]); ?></a><b>&gt;</b>
			...
			<div class="Situation-right">
				<div>
					<div class="SituationRight-top">
						<span>您当前位置：<a href="/index.php/Home/Index/index">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[0]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[0]["nav_name"]); ?></h1>
					</div>
				...
				<div style="display: none">
					<div class="SituationRight-top">
						<span>您当前位置：<a href="index.html">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[1]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[1]["nav_name"]); ?></h1>
					</div>
					<div class="SituationRight-bot">
						<p><?php echo ($company_cultureres["cc_content"]); ?></p>
					</div>
				</div>
				<div style="display: none">
					<div class="SituationRight-top">
						<span>您当前位置：<a href="index.html">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[2]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[2]["nav_name"]); ?></h1>
					</div>
					<div class="SituationRight-bot qualifications">
						<?php if(is_array($certificateres)): $i = 0; $__LIST__ = $certificateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$certificate): $mod = ($i % 2 );++$i;?><div>
								<a href="DetailsOf.html">
									<img src="<?php echo ($certificate["image"]); ?>" alt="..." />
									<div><?php echo ($certificate["title"]); ?></div>
								</a>
				...
				<div style="display: none">
					<div class="SituationRight-top">
						<span>您当前位置：<a href="index.html">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[3]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[3]["nav_name"]); ?></h1>
					</div>
					<div class="SituationRight-bot">
						<p><?php echo ($leader_speechres["ls_content"]); ?></p>
					</div>
				</div>
				<div style="display: none">
					<div class="SituationRight-top">
						<span>您当前位置：<a href="index.html">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[4]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[4]["nav_name"]); ?></h1>
					</div>
					<div class="SituationRight-bot advantage">
					
						<?php if(is_array($service_advantage_res)): $i = 0; $__LIST__ = $service_advantage_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service_advantage): $mod = ($i % 2 );++$i;?><div>
								<h3><?php echo ($service_advantage["sa_advantage_classify"]); ?></h3>
								<p><?php echo ($service_advantage["sa_advantage_content"]); ?></p>
							</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>
				<div style="display: none">
					<div class="SituationRight-top">
						<span>您当前位置：<a href="index.html">首页</a> ><?php echo ($navfirst["nav_name"]); ?> > <?php echo ($navsecond[5]["nav_name"]); ?></span>
						<h1><?php echo ($navsecond[5]["nav_name"]); ?></h1>
					</div>
					<div class="SituationRight-bot contact">
				...
				<div style="display: none">
					<div class="Science">
						<?php if(is_array($company_team_res)): $i = 0; $__LIST__ = $company_team_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company_team): $mod = ($i % 2 );++$i;?><div><img src="<?php echo ($company_team["ct_image"]); ?>" alt="..." /></div>
							<div>
								<a href="Science.html"><?php echo ($company_team["ct_title"]); ?></a>
								<div><?php echo ($company_team["ct_content"]); ?></div>
								<a href="Science.html">查看详情</a>
							</div><?php endforeach; endif; else: echo "" ;endif; ?>
