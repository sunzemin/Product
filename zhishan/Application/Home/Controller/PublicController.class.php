...
class PublicController extends Controller{
	...
	public function bbb(){
		...
		$data['tname']=I('tname');
		$data['tage']=I('tage');
		$data['ttelephone']=I('ttelephone');
		$data['tsex']=I('tsex');
		$data['temail']=I('temail');
		$data['taddress']=I('taddress');
		$data['teducation']=I('teducation','',false);
		$data['tworking']=I('tworking','',false);
		$data['tmessage']=I('tmessage','',false);
		$data['tsort']=I('tsort');
		$data['nav_id']=I('nav_id');
