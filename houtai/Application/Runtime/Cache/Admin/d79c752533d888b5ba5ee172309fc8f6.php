...
<ul class="forminfo">
    <input name="pwc_id" type="hidden" class="dfinput" value="<?php echo ($primary_work_classify["pwc_id"]); ?>" />
    ...
    <li><label><b>*</b>分类名称</label><input name="pwc_name" type="text" class="dfinput" value="<?php echo ($primary_work_classify["pwc_name"]); ?>" /></li>
    <li><label><b>*</b>图标</label><input name="pwc_image" type="text" class="dfinput" value="<?php echo ($primary_work_classify["pwc_image"]); ?>" id="url2"/><input type="button" id="image2" class="scbtn1" value="选择图片"></li>
    <li><label><b>*</b>排序</label><input name="pwc_sort" type="text" class="dfinput" value="<?php echo ($primary_work_classify["pwc_sort"]); ?>" /></li>
