...
<ul class="forminfo">
	<li><label><b>*</b>导航等级</label>
		<select name="fid" class="dfinput state">
    ...
    <li><label><b>*</b>导航名称</label><input name="nav_name" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>链接</label><input name="nav_url" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>排序</label><input name="nav_sort" type="text" class="dfinput" value="" /></li>
    <!-- <li><label><b>*</b>是否推荐</label>
        <select name="nav_state" class="dfinput state">
