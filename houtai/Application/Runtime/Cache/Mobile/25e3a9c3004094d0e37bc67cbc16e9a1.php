 ...
 <input type="hidden" class="navcss" value="<?php echo ($navben["nav_name"]); ?>"> 
		...
		<div class="Situation">
			...
			<div class="classification">
				<ul>
					<?php if(is_array($navsecond)): $k = 0; $__LIST__ = $navsecond;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$second): $mod = ($k % 2 );++$k;?><!--<li>
									
									<a href="/index.php/Mobile/Index/news/nav_id/<?php echo ($second["nav_id"]); ?>/nc_id/<?php echo ($news_classify_res11[$k-1]["nc_id"]); ?>"><?php echo ($second["nav_name"]); ?></a><b>&gt;</b>
								</li>-->
								
								<li>
									
									<a href="/index.php/Mobile/Index/news/nav_id/<?php echo ($second["nav_id"]); ?>/nc_id/<?php echo ($news_classify_res11[$k-1]["nc_id"]); ?>"><?php echo ($second["nav_name"]); ?></a>
								</li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="Situation-bot">
				...
				<div class="SituationRight-bot">
					...
					<?php if(is_array($news_article_res)): $k = 0; $__LIST__ = $news_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news_article): $mod = ($k % 2 );++$k; if($k < 10): ?><div class="news">
								<div class="news-left">
									<div>0<?php echo ($k); ?></div>
									<div><?php echo (date("Y-m",$news_article["na_update"])); ?></div>
								</div>
								<div class="news-right">
									<div>
										<a href="/index.php/Mobile/Index/news1/na_id/<?php echo ($news_article["na_id"]); ?>/nav_id/<?php echo ($news_classify_res["nav_id"]); ?>"><?php echo ($news_article["na_title"]); ?></a>
									</div>
