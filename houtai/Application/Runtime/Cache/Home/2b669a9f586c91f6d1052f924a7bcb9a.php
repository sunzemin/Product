			...
			<div class="Situation-right">
				<div>
					...
					<div class="SituationRight-bot">
						<?php if(is_array($company_team_res)): $i = 0; $__LIST__ = $company_team_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company_team): $mod = ($i % 2 );++$i;?><div class="Science">
								<div><img src="<?php echo ($company_team["ct_image"]); ?>" alt="..."/></div>
								<div>
									<a href="/index.php/Home/Index/Science/ct_id/<?php echo ($company_team["ct_id"]); ?>/nav_id/<?php echo ($navfirst["nav_id"]); ?>"><?php echo ($company_team["ct_title"]); ?></a>
									<div><?php echo ($company_team["ct_content"]); ?></div>
									<a href="/index.php/Home/Index/Science/ct_id/<?php echo ($company_team["ct_id"]); ?>/nav_id/<?php echo ($navfirst["nav_id"]); ?>">查看详情</a>
								</div>
