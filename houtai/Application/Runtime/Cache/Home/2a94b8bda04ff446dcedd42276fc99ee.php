	...
	<ul>
		...
		<section>
			...
			<div class="StyleSample">
				<div class="StyleSample-top">
					<?php if(is_array($caseData)): $i = 0; $__LIST__ = $caseData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$case): $mod = ($i % 2 );++$i;?><a href="/index.php/Home/Index/Information/id/<?php echo ($case["id"]); ?>" target="_blank" class="StyleSampleImages">
							<div class="StyleSampleImages-top">
								<img src="<?php echo ($case["image"]); ?>" alt="img"/>
								<div class="hideDiv"></div>
								<div class="hideDiv2">
									<div>
										<div class="hideDiv2-top">
											<div><?php echo ($company_introduce["ci_logotitle"]); ?></div>
											<div><?php echo ($case["imagetitle"]); ?></div>
										</div>
										<div class="hideDiv2-bot">
											<div>
												<img src="/Public/Home/img/img18.png" alt="img"/>
												<div><?php echo ($company_introduce["ci_logotitle"]); ?></div>
											</div>
											<div><?php echo ($company_introduce["ci_name"]); ?></div>
											<div><?php echo ($company_introduce["ci_url"]); ?></div>
										</div>
									</div>
								</div>
							</div>
							<div class="StyleSampleImages-bot">
								<div><?php echo ($case["title"]); ?></div>
								<div><?php echo ($case["author"]); ?></div>
							</div>
			...
			<div class="vrerInterior">
				...
				<div class="vrerInterior-bot">
					<div class="vrerInterior-left">
						<img src="/Public/Home/img/img31.png" alt="img"/>
					</div>
				...
				<?php if(is_array($home_news_res)): $k = 0; $__LIST__ = $home_news_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$home_news): $mod = ($k % 2 );++$k;?><a href="javascript:;" target="_blank" class="newsImagesCenter">
						...
						<div class="newsImages-three">
							...
							<div class="newsImagesThree-bot">
								...
								<div><?php echo ($home_news["hn_short_title4"]); ?></div>
								<div><?php echo ($home_news["hn_short_title5"]); ?></div>
							</div>
						</div>					
			...
			<div class="CountDown">
				<div class="CountDownCent">
					<?php if(is_array($home_base_res)): $k = 0; $__LIST__ = $home_base_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$home_base): $mod = ($k % 2 );++$k; if($k == 1): ?><div>
								<div class="CountDown-top">
									<!--亲,这有一个id-count,循环的时候注意下-->
			...
			<div id="video">
				<video id="video1" width="100%" height="500" autoplay="autoplay" loop playsinline="true" poster webkit-playsinline="true" muted x-webkit-airplay="allow" x5-video-player-fullscreen="true" x5-video-player-type="h5">
				    <source src="http://cloud.video.taobao.com//play/u/1910949384/p/2/e/6/t/1/50076176739.mp4" type="video/mp4">
				    	short_video
			    ...
			    <div class="videoCent">
					...
					<div class="videoCent-bot">
						<?php echo ($short_video["sv_title_english"]); ?>
					</div>  	
			    </div>
								...
								<div class="evaluateCentData-top">
									...
									<div class="evaluateCentData-right">
										...
										<div class="evaluateCentData-Images">
											<?php $__FOR_START_13053__=1;$__FOR_END_13053__=$custom_word["cw_word_rank"];for($i=$__FOR_START_13053__;$i < $__FOR_END_13053__;$i+=1){ ?><img src="/Public/Home/img/img40.png" alt="img"/><?php } ?>
										</div>
...
<div class="EdnFot2">
	<div class="EdnFotData">
		...
		<script type="text/javascript">
			$(function(){
//				风格样片
				$(".StyleSampleImages").mouseenter(function(){
				...
				$(".StyleSampleImages").mouseleave(function(){
