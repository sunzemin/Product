		...
		<div class="Situation">
			<div class="leftbox">
				<div class="sub-nav">
					...
					<ul>
						<?php if(is_array($navsecond11)): $i = 0; $__LIST__ = $navsecond11;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$navsecondm): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($navsecondm["nav_url"]); ?>/nav_id/<?php echo ($navsecondm["nav_id"]); ?>"><?php echo ($navsecondm["nav_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						<!-- <li><a href="policy.html">政策法规</a><b>&gt;</b></li>
						<li class="on"><a href="problem.html">常见问题</a><b>&gt;</b></li> -->
					</ul>
				</div>
			...
			<div class="Situation-right">
				<div class="SituationRight-top">
					<span>您当前位置：<a href="/index.php/Home/Index/index">首页</a> > <?php echo ($navsecond["nav_name"]); ?> > <?php echo ($navfirst["nav_name"]); ?></span>
					<h1><?php echo ($navfirst["nav_name"]); ?></h1>
				</div>
				<div class="questions">
					<div class="questions-top">
						<div><?php echo ($policy_article["pa_title"]); ?></div>
						<div>作者：管理员 文章来源：本站原创 更新时间：<?php echo (date("Y-m-d H:i:s",$policy_article["pa_update"])); ?> 点击次数：<span>937</span></div>
					</div>
					<div class="questions-bot"><?php echo ($policy_article["pa_content"]); ?></div>
				</div>
				<div class="questions-tab">
					<?php if($policy_articles1 == null): ?><a>上一篇: 没有了 </a>
						<?php else: ?>
						<a href="/index.php/Home/Index/questions/nav_id/<?php echo ($navfirst["nav_id"]); ?>/pa_id/<?php echo ($policy_articles1["na_id"]); ?>/pc_id/<?php echo ($policy_classify["pc_id"]); ?>">上一篇: <?php echo ($policy_articles1["pa_title"]); ?> </a><?php endif; ?>
					<?php if($policy_articles2 == null): ?><a>下一篇: 没有了 </a>
						<?php else: ?>
						<a href="/index.php/Home/Index/questions/nav_id/<?php echo ($navfirst["nav_id"]); ?>/pa_id/<?php echo ($policy_articles2["pa_id"]); ?>/pc_id/<?php echo ($policy_classify["pc_id"]); ?>">下一篇: <?php echo ($policy_articles2["pa_title"]); ?> </a><?php endif; ?>
