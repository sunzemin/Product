		...
		<div class="Situation">
			...
			<div class="Situation-right">
				<div class="SituationRight-top">
					<span>您当前位置：<a href="javascript;">首页</a> > <?php echo ($navsecond["nav_name"]); ?> > <?php echo ($navfirst["nav_name"]); ?></span>
					<h1><?php echo ($navfirst["nav_name"]); ?></h1>
				</div>
				<div class="questions">
					<div class="questions-top">
						<div><?php echo ($certificateres["title"]); ?></div>
						<div>作者：管理员 文章来源：本站原创 更新时间：<?php echo (date("Y-m-d H-i:s",$certificateres["update"])); ?> 点击次数：<span>937</span></div>
					</div>
				...
				<div class="questions-tab">
                    <?php if($certificate1 == null): ?><a>上一篇: 没有了 </a>
                    	<?php else: ?>
                    	<a href="/index.php/Home/Index/DetailsOf/nav_id/<?php echo ($navfirst["nav_id"]); ?>/cid/<?php echo ($certificate1["id"]); ?>">上一篇: <?php echo ($certificate1["title"]); ?> </a><?php endif; ?>
					<?php if($certificate2 == null): ?><a>下一篇: 没有了</a>
						<?php else: ?>
						<a href="/index.php/Home/Index/DetailsOf/nav_id/<?php echo ($navfirst["nav_id"]); ?>/cid/<?php echo ($certificate2["id"]); ?>">下一篇: <?php echo ($certificate2["title"]); ?></a><?php endif; ?>
