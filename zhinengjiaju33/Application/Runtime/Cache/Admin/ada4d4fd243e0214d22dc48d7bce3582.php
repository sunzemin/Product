...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/PrimaryWork/primary_work_classify_add">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($primary_work_classify_res)): $k = 0; $__LIST__ = $primary_work_classify_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($k); ?></td>
                        <td><?php echo ($vo["pwc_name"]); ?></td>
                        <td><?php echo ($navarr[$k-1]["nav_name"]); ?></td>
                        <td><img src="<?php echo ($vo["pwc_image"]); ?>" height="40"></td>
                        <td><?php echo ($vo["pwc_sort"]); ?></td>
                        <td>
                            <!-- <a href="/index.php/Admin/PrimaryWork/primary_work/pwc_id/<?php echo ($vo["pwc_id"]); ?>">文章管理</a> -->
                            <a href="/index.php/Admin/PrimaryWork/primary_work_classify_update/pwc_id/<?php echo ($vo["pwc_id"]); ?>">修改</a>
                            <a href="/index.php/Admin/PrimaryWork/primary_work_classify_del/pwc_id/<?php echo ($vo["pwc_id"]); ?>" onclick="return del()">删除</a>
                        </td>
