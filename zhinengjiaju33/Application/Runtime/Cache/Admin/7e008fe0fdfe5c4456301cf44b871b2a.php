...
<script type="text/javascript">
    ...
    KindEditor.ready(function(k){
        editor=k.create('textarea[name="ls_content"]',{
            filterMode:false
        })
        var editor = k.editor({
...
<ul class="forminfo">
    ...
    <li><label><b>*</b>致辞</label><textarea name="ls_content" type="text" class="dfinput" value="" style="width:500px;height: 400px;"><?php echo ($leader_speech["ls_content"]); ?></textarea></li>
    
    <li><label><b>*</b>排序</label><input name="ls_sort" type="text" class="dfinput" value="<?php echo ($leader_speech["ls_sort"]); ?>" /></li>
