...
<ul class="forminfo">
    <input name="lc_id" type="hidden" class="dfinput" value="<?php echo ($little_classify["lc_id"]); ?>" />
    ...
    <li><label><b>*</b>选择总分类</label>
        <select name="ac_id" class="dfinput">
            <option value="<?php echo ($all_classify11["ac_id"]); ?>"><?php echo ($all_classify11["ac_name"]); ?></option>
    ...
    <li><label><b>*</b>分类名称</label><input name="lc_name" type="text" class="dfinput" value="<?php echo ($little_classify["lc_name"]); ?>" /></li>
    <li><label><b>*</b>排序</label><input name="lc_sort" type="text" class="dfinput" value="<?php echo ($little_classify["lc_sort"]); ?>" /></li>
