...
<ul class="forminfo">
    <li><label><b>*</b>标题</label><input name="pa_title" type="text" class="dfinput" value="" /></li>
    
    <li><label><b>*</b>简介</label><textarea name="pa_content" type="text" class="dfinput" value="" style="width:500px;height: 400px;"></textarea></li>
    <li><label><b>*</b>作者</label><input name="pa_author" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>来源</label><input name="pa_origin" type="text" class="dfinput" value="" /></li>
