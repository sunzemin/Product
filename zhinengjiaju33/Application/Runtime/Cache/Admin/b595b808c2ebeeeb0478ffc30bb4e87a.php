            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" href-url="/index.php/Admin/Index/allhead/p/1"><i class="layui-icon"></i>头部管理</a></dd>
                ...
                <li class="layui-nav-item">
                 ...
                 <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="/index.php/Admin/HomeManage/scene"><i class="layui-icon"></i>场景管理</a></dd> 
                        <dd><a href="javascript:;" href-url="/index.php/Admin/HomeManage/home_decorate_title/p/1"><i class="layui-icon"></i>图标管理</a></dd> 
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child"> 
                        <dd><a href="javascript:;" href-url="/index.php/Admin/Product/product_classify/p/1"><i class="layui-icon"></i>产品分类</a></dd>
                    </dl>
                </li>
            </ul>
