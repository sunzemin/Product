...
<ul class="forminfo">
    ...
    <li><label><b>*</b>标题</label><input name="ct_title" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>图片</label><input name="ct_image" type="text" class="dfinput" value="" id="url1"/><input type="button" id="image1" class="scbtn1" value="选择图片"></li>
    <li><label><b>*</b>内容</label><textarea name="ct_content" class="dfinput" style="width: 500px;height: 400px;"></textarea></li>
    <li><label><b>*</b>排序</label><input name="ct_sort" type="text" class="dfinput" value="" /></li>
