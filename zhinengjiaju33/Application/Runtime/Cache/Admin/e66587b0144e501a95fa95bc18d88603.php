...
<form method="post" name="form" action="">
	<ul class="forminfo">
		...
		<li><label><b>*</b>图标</label>
			<input name="hdt_image" type="text" id="url1" value="" class="dfinput"/>
			<input name="" type="button" id="image1"  class="scbtn1" value="选择图片" />
		</li>
		 <li><label><b>*</b>标题</label><input name="hdt_title" type="text" class="dfinput" value="" /></li>		
         
        <li><label><b>*</b>排序</label><input name="hdt_sort" type="text" class="dfinput" value="" /></li>
