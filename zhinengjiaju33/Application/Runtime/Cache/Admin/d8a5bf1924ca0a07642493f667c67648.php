...
<ul class="forminfo">
    ...
    <li><label><b>*</b>招聘人名称</label><input name="jname" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>所招职位</label><input name="jjob" type="text" class="dfinput" value="" /></li>
    <li><label><b>*</b>所需数量</label><input name="jnum" type="text" class="dfinput" value="" /></li>
    
    <li><label><b>*</b>职位要求</label><textarea name="jrequire" type="text" class="dfinput" style="width: 500px;height: 400px;"></textarea></li>
    <li><label><b>*</b>应聘方法</label><textarea name="jmethod" type="text" class="dfinput" style="width: 500px;height: 400px;"></textarea></li>
    <li><label><b>*</b>职位负责</label><textarea name="jresponsible" type="text" class="dfinput" style="width: 500px;height: 400px;"></textarea></li>
    <li><label><b>*</b>排序</label><input name="jsort" type="text" class="dfinput" value="" /></li>
