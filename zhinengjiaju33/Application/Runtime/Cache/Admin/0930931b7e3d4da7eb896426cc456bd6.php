...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/PrimaryWork/primary_article_add/pw_id/<?php echo ($pw_id); ?>/p/1">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($primary_article_res)): $k = 0; $__LIST__ = $primary_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        <td><?php echo ($k); ?></td>
                        <td><?php echo ($primary_work[$k-1]["pw_name"]); ?></td>
                        <td><?php echo ($vo["pa_sort"]); ?></td>
                        <td>
                            <a href="/index.php/Admin/PrimaryWork/primary_article_update/pw_id/<?php echo ($pw_id); ?>/pa_id/<?php echo ($vo["pa_id"]); ?>/p/1">修改</a>
                            <a href="/index.php/Admin/PrimaryWork/primary_article_del/pw_id/<?php echo ($pw_id); ?>/pa_id/<?php echo ($vo["pa_id"]); ?>/p/1" onclick="return del()">删除</a>
                        </td>
