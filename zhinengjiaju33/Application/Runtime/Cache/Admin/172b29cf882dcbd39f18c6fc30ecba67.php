...
<ul class="forminfo">
    <input name="pa_id" type="hidden" class="dfinput" value="<?php echo ($primary_article["pa_id"]); ?>" />
    <li><label><b>*</b>详细内容</label><textarea name="pa_content" type="text" class="dfinput" style="width: 500px;height: 400px;"><?php echo ($primary_article["pa_content"]); ?></textarea></li>
    <li><label><b>*</b>排序</label><input name="pa_sort" type="text" class="dfinput" value="<?php echo ($primary_article["pa_sort"]); ?>" /></li>
