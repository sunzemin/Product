 ...
 <input type="hidden" class="navcss" value="<?php echo ($navben["nav_name"]); ?>"> 
		...
		<div class="Situation">
			...
			<div class="classification">
				<ul>
					<?php if(is_array($navsecond11)): $k = 0; $__LIST__ = $navsecond11;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$navsecondm): $mod = ($k % 2 );++$k; if($k == 1): ?><li><a href="/index.php/Mobile/Index/policy/nav_id/<?php echo ($navsecondm["nav_id"]); ?>/pc_id/<?php echo ($policy_classify11[$k-1]["pc_id"]); ?>"><?php echo ($navsecondm["nav_name"]); ?></a></li>
							<?php else: ?>
							<li><a href="/index.php/Mobile/Index/problem/nav_id/<?php echo ($navsecondm["nav_id"]); ?>/pc_id/<?php echo ($policy_classify11[$k-1]["pc_id"]); ?>"><?php echo ($navsecondm["nav_name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="Situation-bot">
				...
				<div class="SituationRight-bot questions">
					<div class="questions-top">
						...
						<div>更新时间：<?php echo (date("Y-m-d H:i:s",$policy_article["pa_update"])); ?> 点击次数：<span>937</span></div>
					</div>
					<div class="questions-bot" style="width: 100%;text-indent: 10px;">
						<?php echo ($policy_article["pa_content"]); ?>
					</div>
				</div>
				<div class="questions-tab">
					<?php if($policy_articles1 == null): ?><a>上一篇: 没有了 </a>
						...
						<a href="/index.php/Mobile/Index/problem1/nav_id/<?php echo ($navfirst["nav_id"]); ?>/pa_id/<?php echo ($policy_articles1["pa_id"]); ?>">上一篇: <?php echo ($policy_articles1["pa_title"]); ?> </a><?php endif; ?>
					<?php if($policy_articles2 == null): ?><a>下一篇: 没有了 </a>
						<?php else: ?>
						<a href="/index.php/Mobile/Index/problem1/nav_id/<?php echo ($navfirst["nav_id"]); ?>/pa_id/<?php echo ($policy_articles2["pa_id"]); ?>">下一篇: <?php echo ($policy_articles2["pa_title"]); ?> </a><?php endif; ?>
