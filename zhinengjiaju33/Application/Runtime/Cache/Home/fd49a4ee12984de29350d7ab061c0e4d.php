		...
		for(var i=0;i<len;i++){
			...
			<section>
				<div class="Bedroom">
							...
							<div id="xn_c_prodv_66_wrap" class="xn_c_prodv_66_wrap">
								<div class="xn_c_prodv_66_inner">
									...
									<ul class="xn_c_prodv_66_ul">
										<?php if(is_array($classify_article_res)): $i = 0; $__LIST__ = $classify_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$classify_article): $mod = ($i % 2 );++$i;?><li>
					...
					<div class="Returnlist"><a href="/index.php/Home/Index/quanwujichengzhengzhuang/nav_id/<?php echo ($nav_id); ?>">返回列表</a></div>
