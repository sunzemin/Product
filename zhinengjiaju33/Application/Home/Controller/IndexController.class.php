...
class IndexController extends Controller {
    public function index(){
		...
		for($i=0;$i<count($product_classify_res);$i++){
			$whereAC['pc_id']=$product_classify_res[$i]['pc_id'];
			$product_res=$productM->where($whereAC)->order('psort desc')->select();
			$productarr[]=$product_res;
		}
        
        $this->assign('productres',$productarr);
         //数据总数
    ...
    public function anlizhanshi(){
        ...
        $flag=$this->isMobile();
        if($flag){
            echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/anlizhanshi/nav_id/$nav_id'</script>";
        }
        $this->display();
    }
    public function pinpaijianjie(){
        ...
        $this->assign('navben',$navben);
        //父级导航信息
        $wherepar['nav_id']=$navben['nav_fid'];
        $navpar=$navM->where($wherepar)->find();
        $this->assign('navpar',$navpar);
        $parnavid=$navpar['nav_id'];
    ...
    public function quanwuzhineng(){
        ...
        $flag=$this->isMobile();
        if($flag){
            echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/quanwuzhineng/nav_id/$nav_id'</script>";
        }
        $this->display();
    }
    public function xinwenxiangqing(){
        ...
        if($flag){
        	if(isset($id)){
        		echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/xinwenxiangqing/nav_id/$nav_id/id/$id'</script>";
        	}else{
        		echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/xinwenxiangqing/nav_id/$nav_id/ca_id/$ca_id'</script>";
        	} 
        }
        $this->display();
    }
    ...
    public function changjingtiyanzhongxin(){
        ...
        $flag=$this->isMobile();
        if($flag){
            echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/changjingtiyanzhongxin/nav_id/$nav_id'</script>";
        }
        $this->display();
    }
    public function chanpinzhongxin(){
        ...
        if($flag){
            if($navpar==null){
                ...
                echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/chanpinzhongxin/nav_id/$parnavid/snavid/$nav_id'</script>";
            }  
        }
        $this->display();
    }
    ...
    public function quanwujichengxiangqing(){
        ...
        $flag=$this->isMobile();
        if($flag){
            echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/quanwujichengxiangqing/nav_id/$nav_id/lc_id/$lc_id'</script>";
        }
        $this->display();
    }
...
//      dump($little_classify12);
        ...
        $flag=$this->isMobile();
        if($flag){
            echo "<script type='text/javascript'>location.href='/index.php/Mobile/Index/pinpairongyu/nav_id/$parnavid'</script>";
        }
        $this->display();
    }
