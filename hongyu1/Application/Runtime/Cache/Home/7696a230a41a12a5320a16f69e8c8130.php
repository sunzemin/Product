			...
			<div class="vrerInterior">
				...
				<div class="StyleSample">
					<div class="StyleSample-top">
						<?php if(is_array($room_scenery_res)): $k = 0; $__LIST__ = $room_scenery_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$room_scenery): $mod = ($k % 2 );++$k;?><a href="/index.php/Home/Index/Information/rs_id/<?php echo ($room_scenery["rs_id"]); ?>" target="_blank" class="StyleSampleImages">
								...
								<div class="hideDiv2">
									<div>
										<div class="hideDiv2-top">
											<div>Vera Mansion</div>
											<div>travel around the world</div>
										</div>
										<div class="hideDiv2-bot">
											...
											<div>Vera Mansion Wedding Photography</div>
											<div>www.xyvera520.com</div>
										</div>
									</div>
								</div>
							</div>
							<div class="StyleSampleImages-bot">
								<div><?php echo ($room_scenery["rs_name"]); ?></div>
								<div><?php echo ($room_scenery_classify11[$k-1]["rsc_name"]); ?></div>
							</div>
