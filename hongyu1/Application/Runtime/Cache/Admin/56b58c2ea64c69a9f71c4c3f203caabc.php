...
<form method="post" name="form" action="">
	<ul class="forminfo">
		<li><label><b>*</b>图片</label>
			<input name="fu_image" type="text" id="url1" value="" class="dfinput"/>
			<input name="" type="button" id="image1"  class="scbtn1" value="选择图片" />
		</li>
					
	    <li><label><b>*</b>链接</label><input name="fu_url" type="text" class="dfinput" value="" /></li>
	   
	    <li><label><b>*</b>排序</label><input name="fu_sort" type="text" class="dfinput" value="" /></li>
