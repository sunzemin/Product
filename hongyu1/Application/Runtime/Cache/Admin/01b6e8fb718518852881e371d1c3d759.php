...
<div class="index-right">
    <div class="formbody">
        <div class="tools">
            <ul class="toolbar">
                <a href="/index.php/Admin/Classify/classify_article_add/p/<?php echo ($p); ?>/lc_id/<?php echo ($lc_id); ?>">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($classify_article_res)): $k = 0; $__LIST__ = $classify_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td><?php echo ($vo["ca_min"]); ?></td>
                        <td><?php echo ($vo["ca_sort"]); ?></td>
                        <td>
                            <a href="/index.php/Admin/Classify/classify_article_update/ca_id/<?php echo ($vo["ca_id"]); ?>/lc_id/<?php echo ($lc_id); ?>/p/<?php echo ($p); ?>">修改</a>
                            <a href="/index.php/Admin/Classify/classify_article_del/ca_id/<?php echo ($vo["ca_id"]); ?>/lc_id/<?php echo ($lc_id); ?>/p/<?php echo ($p); ?>" onclick="return del()">删除</a>
                        </td>
        ...
        <?php if($page == ''): else: ?>
            ...
            <?php if($p == 1): ?><li style="float: left;list-style: none;width:50px;height: 30px;border: 1px solid black;text-decoration: center;line-height: 30px;"><a href="/index.php/Admin/Classify/classify_article/p/1/lc_id/<?php echo ($lc_id); ?>" style="margin-left: 20px;"><<</a></li>
                <?php else: ?>
