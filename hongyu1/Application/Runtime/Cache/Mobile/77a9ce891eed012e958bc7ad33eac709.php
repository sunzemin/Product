 ...
 <input type="hidden" class="navcss" value="<?php echo ($navben["nav_name"]); ?>"> 
		...
		<div class="Situation">
			<div class="Situation-top">
				<p><?php echo ($navfirst["nav_name"]); ?></p>
				<p>NEWS</p>
			</div>
			<div class="classification">
				<ul>
					<?php if(is_array($navsecond)): $k = 0; $__LIST__ = $navsecond;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$second): $mod = ($k % 2 );++$k; if($k == 1): ?><li>
									
									<a href="/index.php/Mobile/Index/policy/nav_id/<?php echo ($second["nav_id"]); ?>/pc_id/<?php echo ($policy_classify_res11[$k-1]["pc_id"]); ?>"><?php echo ($second["nav_name"]); ?></a>
								</li>
								<?php else: ?>
								<li>
									
									<a href="/index.php/Mobile/Index/problem/nav_id/<?php echo ($second["nav_id"]); ?>/pc_id/<?php echo ($policy_classify_res11[$k-1]["pc_id"]); ?>"><?php echo ($second["nav_name"]); ?></a>
								</li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="Situation-bot">
				<div class="SituationRight-top">
					<span>您当前位置：<a href="/index.php/Mobile/Index/index">首页</a> > <?php echo ($navfirst["nav_name"]); ?> > <?php echo ($policy_classify_res["pc_name"]); ?></span>
					<h1><?php echo ($policy_classify_res["pc_name"]); ?></h1>
				</div>
								...
								<div id="scrollDiv">
									<ul>
										...
										<?php if(is_array($policy_article_res)): $i = 0; $__LIST__ = $policy_article_res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$policy_article): $mod = ($i % 2 );++$i;?><li>
											<dl>
												<dt><a href="/index.php/Mobile/Index/problem1/pa_id/<?php echo ($policy_article["pa_id"]); ?>/nav_id/<?php echo ($policy_classify_res["nav_id"]); ?>" ><?php echo ($policy_article["pa_title"]); ?></a></dt>
												<dd>
													<p class="text"><?php echo ($policy_article["pa_content"]); ?>
													</p>
													<p class="btn">
														<a href="/index.php/Mobile/Index/problem1/pa_id/<?php echo ($policy_article["pa_id"]); ?>/nav_id/<?php echo ($policy_classify_res["nav_id"]); ?>" ></a>
													</p>
												</dd>
											</dl>
										</li><?php endforeach; endif; else: echo "" ;endif; ?>
