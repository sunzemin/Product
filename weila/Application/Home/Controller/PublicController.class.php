...
class PublicController extends Controller{
    ...
    public function customspeech($k=0,$p=1){
        ...
        echo json_encode(array('custom_word_res'=>$custom_word_res,'p'=>$p,'page'=>$page,'allcount'=>$allcount));
        // $this->ajaxReturn(array('custom_word_res'=>$custom_word_res,'p'=>$p,'page'=>$page,'allcount'=>$allcount),'JSON');
    }
    public function selcase($p=1){
        ...
        $this->ajaxReturn(array('caseData'=>$caseData,'allcount'=>$caseallcount,'allpage'=>$casepage,'p'=>$p,'company_introduce'=>$company_introduce));
